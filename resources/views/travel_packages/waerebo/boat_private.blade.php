            ...
            <ul class="cards" style="display: flex; justify-content: center;">
                <li class="cards_item" style="width: 20rem; height: auto; position: relative; margin-right: 1rem;">
                    <div class="card">
                        ...
                        <div class="card_content">
                            <a href="{{ route('show.private_trip.boat.bronze.waerebo') }}" class="card_title"
                ...
                <li class="cards_item" style="width: 20rem; height: auto; position: relative; margin-right: 1rem;">
                    <div class="card">
                        ...
                        <div class="card_content">
                            <a href="{{ route('show.private_trip.boat.silver.waerebo') }}" class="card_title"
                ...
                <li class="cards_item" style="width: 20rem; height: auto; position: relative;">
                    <div class="card">
                        ...
                        <div class="card_content">
                            <a href="{{ route('show.private_trip.boat.gold.waerebo') }}" class="card_title"
