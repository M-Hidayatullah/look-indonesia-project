    ...
    <section class="section" id="package-type">
        <div class="container" style="display: flex; justify-content: center;">
            <div class="package-type__card" style="width: 20rem; margin: 0 10px; display: flex; flex-direction: column;">
                ...
                <a href="{{ route('show.boat.private-trip.raja-ampat', $travel_package->slug) }}" class="button button--private-trip"
            ...
            <div class="package-type__card" style="width: 20rem; margin: 0 10px; display: flex; flex-direction: column;">
                ...
                <a href="{{ route('show.boat.open-trip.raja-ampat', $travel_package->slug) }}" class="button button--open-trip"
                    style="display: block; margin-top: auto;">Explore</a>
            </div>
        </div>
    </section>
